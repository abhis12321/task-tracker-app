...
export default function TaskColumnContainer() {
    ...
    return (
        <div className="w-full max-w-[600px] gap-3 flex flex-col shadow-[0_0_20px_black] rounded pb-4 my-4 bg-green-700/20">
            <div className='w-full flex items center justify-around  bg-white shadow-[0_0_15px_black] rounded-lg *:rounded-lg text-xs sm:text-sm font-bold sm:font-extrabold'>
